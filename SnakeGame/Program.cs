...
namespace SnakeGame
{
    class Program
    {
        ...
        {
            shapesToPrint = new Random().Next(5,6);
            Line l = new Line(new Point(), '#', Console.ForegroundColor = ConsoleColor.Green);
            Triangle t = new Triangle(new Point(), '^', Console.ForegroundColor = ConsoleColor.DarkBlue);
            rectangle r = new rectangle(new Point(), '@', Console.ForegroundColor = ConsoleColor.DarkYellow);
            square s = new square(new Point(), '$', Console.ForegroundColor = ConsoleColor.Cyan);

            SetConsole(80, 25);
            shapes = new List<BaseShape> { l, t, s, r };
